...
<div class="template-color-1 template-font-1">
    ...
    <div id="wrapper" class="wrapper">
        ...
        <main class="page-content">
            ...
            <div id="newEvent"
                class="bk-blog-grid-area pt--70 pb--100 pt_md--80 pb_md--80 pb_sm--80 pt_sm--0 bg_color--1">
                <div class="container">
                    <div class="row">
                        ...
                        >
                            <div class="blog-grid">
                                <div class="post-thumb blog-slick-initial poss_relative" style="width: 100%;height: 143px;">
                                    <a :href="item.link">
