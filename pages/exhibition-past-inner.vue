      ...
      <headerBar></headerBar>
        ...
        <main class="page-content">
            ...
            <div id="pastEvent" class="bk-blog-grid-area pt--70 pb--100 pt_md--80 pb_md--80 pb_sm--80 pt_sm--0 bg_color--5">
                <div class="container">
                    <h1 style="font-size: 30px; color: black; margin-bottom: 8px;">{{ exhibitionContent[this.queryIndex].title }}</h1>
                    <h1 style="font-size: 18px; color: black; ">{{ exhibitionContent[this.queryIndex].postDate.substr(0, 11) }}</h1>
                    <br>
                    <div>
                        <!-- Start Single Blog -->
